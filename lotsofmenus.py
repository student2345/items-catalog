...
menuItem2 = MenuItem(
    ...
    ", with authentic versions of the dish serving mostly the skin and" +
...
menuItem3 = MenuItem(
    ...
    description="Seared rare ahi, avocado, edamame, cucumber with" +
    " wasabi soy sauce ",
    price="15",
    course="Entree",
    restaurant=restaurant2)
...
menuItem4 = MenuItem(
    ...
    "spiced soya,garlic sauce cooked with fresh cilantro, celery, " +
...
menuItem5 = MenuItem(
    ...
    "garbanzo beans, curry sauce, potatoes (aloo), fried cauliflower " +
...
menuItem1 = MenuItem(
    user_id=1,
    name="Lamb Curry",
    description="Slow cook that thang in a pool of tomatoes, onions " +
    "and alllll those tasty Indian spices. Mmmm.",
    price="$9.95",
    course="Entree",
    restaurant=restaurant1)
...
menuItem4 = MenuItem(
    ...
    "a spicy mix(chilli, tamarind among others) and slow cooked in " +
